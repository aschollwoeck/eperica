...
- [ ] **T1 — Migration + `World.rule_preset`.** `0046_world_rule_preset.sql` adds `rule_preset text NOT NULL
...
- [ ] **T2 — Name-aware loader + callers.** `load_world_rules(preset: &str)` (classic-only; unknown ⇒
