...
- [ ] **T1 — Manual infrastructure.** pulldown-cmark; manual.rs registry (six sections,
...
- [ ] **T3 — Prose rework wave 1.** Getting started + Economy + Military sections rewritten per
  the voice rules; big tables → reference links; README regenerated (six sections). (AC6)
- [ ] **T4 — Prose rework wave 2.** Expansion + Society + Reference-section prose (artifacts,
