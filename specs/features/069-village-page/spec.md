...
- **AC1 — Command header.** A stamped header with the village name (+ capital star), a coordinate chip, the
  population / oases / protection line, **loyalty** and **village-slots** dials, the multi-village switcher, and
  quick-links (Map, Rally, Market, Academy, Smithy, training, Reports, Quests, Alliance). World-won, wonder-site
  and protection notices are surfaced here.
...
- **AC3 — Fortress plan.** A top-down rampart (towers + gate) with the **buildings** as plots inside, placed by
  ...
  glows ember; an **under-construction** building shows a progress sliver + countdown; an **empty/buildable**
  slot reads as available. Clicking a plot opens the **inspector**.
